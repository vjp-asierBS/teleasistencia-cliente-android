 ...
 * Use the {@link FragmentInsertarTipoRecursoComunitario#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentInsertarTipoRecursoComunitario extends Fragment implements View.OnClickListener {
    ...
    public FragmentInsertarTipoRecursoComunitario() {
     ...
     * @return A new instance of fragment FragmentInsertarTipoRecursoComunitario.
     */
    public static FragmentInsertarTipoRecursoComunitario newInstance() {
        FragmentInsertarTipoRecursoComunitario fragment = new FragmentInsertarTipoRecursoComunitario();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Se guarda la vista.
        View root = inflater.inflate(R.layout.fragment_insertar_tipo_recurso_comunitario, container, false);
    ...
    private void accionBotonGuardar() {
        if (validarTipoRecursoComunitario()) {
            insertarTipoRecursoComunitario();
        }
    }
    ...
    /**
     * Método que inserta el tipo de recurso comunitario.
     */
    private void insertarTipoRecursoComunitario() {
        String nombre = this.editTextPedirNombre.getText().toString();

        TipoRecursoComunitario tipoRecursoComunitario = new TipoRecursoComunitario(nombre);

        APIService apiService = ClienteRetrofit.getInstance().getAPIService();
        Call<Object> call = apiService.postTipoRecursoComunitario(tipoRecursoComunitario, Constantes.BEARER_ESPACIO + Utilidad.getToken().getAccess());
        call.enqueue(new Callback<Object>() {
            @Override
            public void onResponse(Call<Object> call, Response<Object> response) {
                if (response.isSuccessful()) {
                    Object tipoRecursoComunitario = response.body();
                    System.out.println(tipoRecursoComunitario);
                    Toast.makeText(getContext(), Constantes.MENSAJE_INSERTAR_TIPO_RECURSO_COMUNITARIO, Toast.LENGTH_SHORT).show();
                    borrarEditTexts();
                } else {
                    Toast.makeText(getContext(), Constantes.ERROR_MENSAJE_INSERTAR_TIPO_RECURSO_COMUNITARIO, Toast.LENGTH_SHORT).show();
                }
            }
