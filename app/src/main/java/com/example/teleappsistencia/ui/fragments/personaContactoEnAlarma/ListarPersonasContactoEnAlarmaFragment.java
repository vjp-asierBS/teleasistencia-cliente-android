 ...
 * Use the {@link ListarPersonasContactoEnAlarmaFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ListarPersonasContactoEnAlarmaFragment extends Fragment {


    private ArrayList<PersonaContactoEnAlarma> lContactosEnAlarma;

    private RecyclerView recycler;
    private RecyclerView.Adapter adapter;
    private RecyclerView.LayoutManager lManager;

    public ListarPersonasContactoEnAlarmaFragment() {
     ...
     *
     * @return A new instance of fragment ListarPersonasContactoEnAlarmaFragment.
     */

    public static ListarPersonasContactoEnAlarmaFragment newInstance() {
        ListarPersonasContactoEnAlarmaFragment fragment = new ListarPersonasContactoEnAlarmaFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_listar_personas_contacto_en_alarma, container, false);
        ...
        this.lContactosEnAlarma = new ArrayList<>();
    ...
    private void cargarLista(){
        ...
        Call<List<Object>> call = apiService.getPersonasContactoEnAlarma(Constantes.BEARER_ESPACIO + Utilidad.getToken().getAccess());
