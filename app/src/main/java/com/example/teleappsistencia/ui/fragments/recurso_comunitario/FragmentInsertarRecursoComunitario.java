 ...
 * Use the {@link FragmentInsertarRecursoComunitario#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentInsertarRecursoComunitario extends Fragment implements View.OnClickListener {
    ...
    public FragmentInsertarRecursoComunitario() {
     ...
     * @return A new instance of fragment FragmentInsertarRecursoComunitario.
     */
    public static FragmentInsertarRecursoComunitario newInstance() {
        FragmentInsertarRecursoComunitario fragment = new FragmentInsertarRecursoComunitario();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Se guarda la vista.
        View root = inflater.inflate(R.layout.fragment_insertar_recurso_comunitario, container, false);
        ...
        // Se llama al método que se encarga de rellenar el spinner con los tipos de recursos comunitarios.
    ...
    /**
     * Método que rellena el spinner con los tipos de recursos comunitarios.
     */
        ...
        call.enqueue(new Callback<List<TipoRecursoComunitario>>() {
            ...
            public void onResponse(Call<List<TipoRecursoComunitario>> call, Response<List<TipoRecursoComunitario>> response) {
                if (response.isSuccessful()) {
                    List<TipoRecursoComunitario> listadoTipoRecursoComunitario = response.body();
                    ArrayAdapter adapter = new ArrayAdapter(getContext(), android.R.layout.simple_spinner_item, listadoTipoRecursoComunitario);
    ...
    /**
     * Método que inserta el recurso comunitario.
     */
    private void insertarRecursoComunitario() {
        String nombre = this.editTextPedirNombre.getText().toString();
        String telefono = this.editTextPhonePedirTelefono.getText().toString();
        TipoRecursoComunitario tipoRecursoComunitario = (TipoRecursoComunitario) this.spinnerTipoRecursoComunitario.getSelectedItem();
        ...
        this.recursoComunitario = new RecursoComunitario();
        recursoComunitario.setNombre(nombre);
        recursoComunitario.setTelefono(telefono);
        recursoComunitario.setTipoRecursoComunitario(tipoRecursoComunitario.getId());
        ...
        call.enqueue(new Callback<Object>() {
            ...
            public void onResponse(Call<Object> call, Response<Object> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(getContext(), Constantes.MENSAJE_INSERTAR_RECURSO_COMUNITARIO, Toast.LENGTH_SHORT).show();
                    borrarEditTexts();
                } else {
                    Toast.makeText(getContext(), Constantes.ERROR_MENSAJE_INSERTAR_RECURSO_COMUNITARIO, Toast.LENGTH_SHORT).show();
                }
            }
